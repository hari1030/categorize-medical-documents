...
for idx,tu in enumerate(Test_X):
    print("article : "+str(test_z.iloc[idx])+" => " +lab[predictions_NB[idx]]+"\n")
print("Naive Bayes Accuracy Score -> ",accuracy_score(predictions_NB, Test_Y)*100,"\n\nclassification report\n\n")
print(metrics.classification_report(Test_Y,predictions_NB,target_names=lab))
print("\nconfusion matrix\n\n",metrics.confusion_matrix(predictions_NB, Test_Y))
