...
for idx,tu in enumerate(Test_X):
    print("article : "+str(test_z.iloc[idx])+" => " +lab[y_pred[idx]]+"\n")
#print(Test_Y)
# Use accuracy_score function to get the accuracy
print("RFC Accuracy Score -> ",accuracy_score(y_pred, Test_Y)*100,"\n\nclassification report\n\n")
print(metrics.classification_report(Test_Y,y_pred,target_names=lab))
